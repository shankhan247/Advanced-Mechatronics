...
int main() {
    ...
    unsigned char write_address = 0x40;
    unsigned char read_address = 0x41;
    unsigned char reg = 0x00;
    unsigned char data = 0x00;
    unsigned char rec_val;
    i2c_master_setup();
    
    // defining A pins as output (LED))
    write(write_address, reg, data);
    
    // defining B pins as input (button)
    reg = 0x01;
    data = 0xFF;
    ...
    while (1) {
        ...
        rec_val = read(write_address, read_address, reg);
